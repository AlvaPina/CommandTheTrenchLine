...
- **Tiendas de campaña / Hospital**: Las armies cuando huyen irán hasta esta zona la cual se encuentra en un extremo del mapa y se curarán ahí. Es un intercambio de tiempo por recuperación de vida. La recuperación de vida consiste en un 50% del daño **máximo** recibido (con máximo me refiero al mayor daño recibido en esa partida para que no se puedan curar de manera infinita). Por ejemplo, si una armie llega con 30 de vida, quiere decir que el daño recibido (sobre 100) son 60 y por tanto la recuperación de la vida será de 30 lo que hará un total de 60 de vida cuando salga del hospital. Cada punto de vida es 1 segundo.
